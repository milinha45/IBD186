...
public class App 
{
	...
	public static void main( String[] args )
    {
		...
		try {
			seg.criarEmpresa("Y", "123412364/0001", "SP");
		}
		catch(Exception e) {
			System.out.println("Rollback realizado!");
			e.printStackTrace();
		...
		Empresa resultEmpresa = seg.queryEmpresaTop1ByNomeContains("X");
		System.out.println("Nome: " + resultEmpresa.getNome() + " CNPJ: " + resultEmpresa.getCnpj());
